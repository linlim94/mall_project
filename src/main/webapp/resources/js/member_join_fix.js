...
window.onload = function() {
	...
	join_submit.onclick = function() {
		...
		// 필수 항목 입력 여부 점검
		if(join_id.value == '' || join_pwd.value == '' || join_pwdCheck.value == ''
			|| join_name.value == ''|| join_email.value == '' || join_phone.value == '')
		{ 
			alert("필수사항을 빠짐없이 입력해주세요.")
		}
		// 필수 항목 점검
		else if (id_check_flag == true && // 아이디 중복 점검 플래그 변수
