...
public class ShoeShopCrawl {
	...
	public void productDummyGenerator() throws IOException {
		...
		// String url = "https://www.saltandchocolate.co.kr/goods/goods_list.php?cateCd=001014"; // 부츠(O) 2
		// String url = "https://www.saltandchocolate.co.kr/goods/goods_list.php?cateCd=001021"; // 샌들/슬리퍼(O) 3
		// String url = "https://www.saltandchocolate.co.kr/goods/goods_list.php?cateCd=001019"; // 블로퍼/뮬(O) 4
		// String url = "https://www.saltandchocolate.co.kr/goods/goods_list.php?cateCd=001013"; // 스니커즈 (문제 발생 : tx rollback) 5
		...
		for (int i=0; i<rawProducts.size(); i++) {
			...
			int price1 = Integer.parseInt(rawProducts.get(i).getAllElements()
													 .select("div[class='item_money_box'] [class='seum_fixed_price']")
													 .html().replaceAll("[원, ]", ""));
