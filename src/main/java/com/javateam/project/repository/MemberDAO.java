...
public class MemberDAO {
	...
	private static final String MAPPER_NS = "com.javateam.project.mapper.Member.";
	...
	public boolean isMember(String id) {
		...
		return (int)sqlSession.selectOne(MAPPER_NS + "isMember", 
							id) == 1 ? true : false;
	...
	public boolean isEmail(String email) {
		...
		return (int)sqlSession.selectOne(MAPPER_NS + "isEmail", 
				email) == 1 ? true : false;
	} //
	...
	public boolean isPhone(String phone) {
		...
		return (int)sqlSession.selectOne(MAPPER_NS + "isPhone", 
				phone) == 1 ? true : false;
	} //
	...
	public void insertMember(MemberVO memberVO) {
		...
		sqlSession.insert(MAPPER_NS + "insertMember", memberVO);
	}
	...
	public void insertRole(RoleVO roleVO) {
		...
		sqlSession.insert(MAPPER_NS + "insertRole", roleVO);
	}
	...
	public boolean isMemberByIdPwd(String id, String pwd) {
		...
		return (int)sqlSession.selectOne(MAPPER_NS + "isMemberByIdPwd", member)
				== 1 ? true : false;
	}
	...
	public String findIdByNamePhone(String name, String phone) {
		...
		log.info("MemberDAO.fineIdByNamePhone");
		
		HashMap<String, String> map = new HashMap<>();
		map.put("name", name);
		map.put("phone", phone);
		
		return sqlSession.selectOne(MAPPER_NS + "findIdByNamePhone", map);
	 ...
	 * @return pwd 회원 비밀번호
	 */
	public String findPwdByIdPhone(String id, String phone) {
		
		log.info("MemberDAO.findPwdByIdPhone");
		
		HashMap<String, String> map = new HashMap<>();
		map.put("id", id);
		map.put("phone", phone);
		
		return sqlSession.selectOne(MAPPER_NS + "findPwdByIdPhone", map);
	...
	public MemberVO getMember(String id) {
		...
		return sqlSession.selectOne(MAPPER_NS + "getMember", id);
	}
	...
	public void updateMember(MemberVO memberVO) {
		...
		sqlSession.update(MAPPER_NS + "updateMember", memberVO);
	}
	...
	public boolean isEmailOnUpdate(String id, String email) {
		...
		return (int)sqlSession.selectOne(MAPPER_NS + "isEmailOnUpdate", map) 
				== 1 ? true : false;
	}
	...
	public boolean isPhoneOnUpdate(String id, String phone) {
		...
		return (int)sqlSession.selectOne(MAPPER_NS + "isPhoneOnUpdate", map) 
				== 1 ? true : false;
	}
	...
	public boolean inactiveMember(String id) {
		...
		return sqlSession.update(MAPPER_NS + "inactiveMember", id) >= 1 ? true : false;
	}
	...
	public boolean inactiveRole(String id) {
		...
		return sqlSession.update(MAPPER_NS + "inactiveRole", id) >= 1 ? true : false;
	}
	...
	public boolean isActiveMember(String id) {
		...
		try {
			...
			return sqlSession.selectOne(MAPPER_NS + "isActiveMember", id).equals("y") ? true : false;
...
//		boolean flag = sqlSession.selectOne(MAPPER_NS + "isActiveMember", id).equals("y") ? true : sqlSession.selectOne(MAPPER_NS + "isActiveMember", id)==null ? false : false;
//	
//		map.put("id", flag);
//		
//		return map;
		// return sqlSession.selectOne(MAPPER_NS + "isActiveMember", id).equals("y") ? true : sqlSession.selectOne(MAPPER_NS + "isActiveMember", id)==null ? false : false;
		// return sqlSession.selectOne(MAPPER_NS + "isActiveMember", id).equals("y") ? true : false;		
	}
	...
	public void activeMember(String id, String useyn) {
		...
		sqlSession.update(MAPPER_NS + "activeMember", map);
	}
	...
	public void activeRole(String id, String role) {
		...
		sqlSession.update(MAPPER_NS + "activeRole", map);
	}
	...
	public boolean isMemberByRequired(MemberVO memberVO) {
		...
		return (int)sqlSession.selectOne(MAPPER_NS + "isMemberByRequired", memberVO)
				 == 1 ? true : false;
	}
	...
	public String getRole(String id) {
		...
		return sqlSession.selectOne(MAPPER_NS + "getRole", id);
	}
	...
	public List<MemberRoleVO> getMembersByPaging(int page, int limit) {
		...
		return sqlSession.selectList(MAPPER_NS + "getMembersByPaging", map);
	}
	...
	public int getTotalMembersCount() {
		...
		return sqlSession.selectOne(MAPPER_NS + "getTotalMembersCount");
	}
	...
	public List<MemberRoleVO> searchMembersByPaging(SearchVO searchVO) {
		...
		if (searchVO.getSearchFld().equals("id")) {
			...
			log.info("검색어 : " + searchVO.getSearchWord());
			searchVO.setSearchWord("%"+searchVO.getSearchWord()+"%");
		}
		
		return sqlSession.selectList(MAPPER_NS + "searchMembersByPaging", searchVO);
	}
	...
	public int getCountSearchMembersByPaging(SearchVO searchVO) {
		...
		return (int)sqlSession.selectOne(MAPPER_NS + "getCountSearchMembersByPaging", searchVO);
	}
	...
	public void updateMemberByAdmin(String id, String fld, String val) {
		...
		map.put("fld", fld);
		map.put("val", val);		
		sqlSession.update(MAPPER_NS + "updateMemberByAdmin", map);
	} //
}