...
//	} //
	...
	*/
	...
	public String findIdByNamePhone(String name, String phone) {
		...
		log.info("MemberService.findIdByNamePhone");
		
		return txTemplate.execute(status -> { return memberDAO.findIdByNamePhone(name, phone); });
	}
	...
	public String findPwdByIdPhone(String id, String phone) {
		...
		log.info("MemberService.findPwdByIdPhone");
		
		return txTemplate.execute(status -> { return memberDAO.findPwdByIdPhone(id, phone); });
	}
